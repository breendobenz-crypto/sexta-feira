...
/* ═══════════════════════════════════════════════════════════════
   BOTÕES UNIFICADOS — COR ROXA DO TÍTULO (#8A2BE2)
═══════════════════════════════════════════════════════════════ */
.stButton > button {
...
.stButton > button:hover {
    ...
    box-shadow: 0 0 25px rgba(138, 43, 226, 0.7) !important;
...
/* Botão ACESSAR e todos os botões de form — mesma cor roxa do título */
...
<h1 style="
    ...
    letter-spacing: clamp(2px, 1.5vw, 5px) !important;
