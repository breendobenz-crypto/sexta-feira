...
# ==========================================
# FAVICON PERSONALIZADO (SF SVG)
# ==========================================
# Injeta um SVG base64 no HEAD do navegador para ser o ícone da aba
_favicon_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><polygon points="50,5 90,25 90,75 50,95 10,75 10,25" fill="#0a0a0a" stroke="#8A2BE2" stroke-width="5"/><text x="50" y="68" font-family="sans-serif" font-weight="bold" font-size="45" fill="#8A2BE2" text-anchor="middle">SF</text></svg>"""
st.markdown(f"""
<link rel="icon" href="data:image/svg+xml;base64,{_favicon_svg}">
<link rel="shortcut icon" href="data:image/svg+xml;base64,{_favicon_svg}">
...
/* CORREÇÃO: Remove barra lateral e rodapé padrão */
#MainMenu, footer, header { visibility: hidden; }
.stDecoration { display: none; }

/* ================= CORREÇÃO DA ESFERA (FUNDO BRANCO) ================= */
/* Garante que o iframe da esfera tenha fundo transparente */
iframe {
...
<div id="task-text"></div>
    ...
    # TÍTULO CENTRALIZADO COM CARD (MARGEM AJUSTADA PARA SUBIR)
    st.markdown("""
    <div style="text-align:center; margin: -130px 0 18px;">
